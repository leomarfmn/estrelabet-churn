...
from templates import CUSTOM_CSS, INSTRUCTIONS
...
with gr.Blocks(css=CUSTOM_CSS) as interface:
    with gr.Row():
        with gr.Column(scale=1):
            gr.Image("estrela-betlogo.png", show_label=False, height=150, width=300, show_download_button=False)
        with gr.Column(scale=6):
            gr.Markdown("# <div style='text-align: right; display: flex; align-items: center; height: 150px; justify-content: flex-end;'>Churn Prediction</div>")
